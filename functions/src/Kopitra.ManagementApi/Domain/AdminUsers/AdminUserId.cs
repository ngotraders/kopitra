...
public sealed class AdminUserId : Identity<AdminUserId>
{
    public AdminUserId(string value) : base(value)
    {
    }

    public static AdminUserId FromBusinessId(string businessId)
    {
        ...
        var guid = CreateDeterministicGuid("adminuser", normalized);
        return With($"adminuser-{guid:D}");
    }
